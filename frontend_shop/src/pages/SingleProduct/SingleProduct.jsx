import productNavPrev from "../../assets/images/products/product-nav-prev.jpg";
import productNavNext from "../../assets/images/products/product-nav-next.jpg";
import defImg from "../../assets/images/products/default/1-800x900.jpg";
import defImg2 from "../../assets/images/products/default/2-800x900.jpg";
import videoBanner from "../../assets/images/products/video-banner-610x300.jpg";
                ...
                <div className="tab-content">
                    ...
                    <div className="row mb-4">
                      <div className="col-md-6 mb-5">
                        ...
                        <p className="mb-4">
                          ...
                          Tellus rutrum tellus pelle Vel pretium lectus quam id
                  ...
                  <div className="tab-pane" id="product-tab-vendor">
                    ...
                    <p className="mb-5">
                      ...
                      Vel pretium lectus quam id leo in vitae turpis massa. Nunc
                      id cursus metus aliquam. Libero id faucibus nisl tincidunt
                      eget. Aliquam id diam maecenas ultricies mi eget mauris.
                      Volutpat ac tincidunt vitae semper quis lectus. Vestibulum
                      mattis ullamcorper velit sed. A arcu cursus vitae congue
                      mauris.
                    </p>
                    <p className="mb-2">
                      ...
                      sollicitudin ac orci phasellus. A condimentum vitae sapien
                      pellentesque habitant morbi tristique senectus et. In
                      dictum non consectetur a erat. Nunc scelerisque viverra
